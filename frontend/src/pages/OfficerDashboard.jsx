...
export default function OfficerDashboard() {
    ...
    useEffect(() => {
        if (selectedSector) {
            ...
            fetchQueues();
            const interval = setInterval(fetchQueues, 30000); // 30s auto-refresh
            ...
            <aside className="w-80 border-r border-border bg-card hidden lg:flex flex-col p-8 space-y-10">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <span className="font-black text-lg uppercase leading-none">Officer Portal</span>
                    ...
                    <div className="max-w-6xl mx-auto space-y-8">
                        ...
                        <div className="flex justify-between items-center bg-card p-6 rounded-[32px] border border-border">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <div className="text-3xl font-black">Now Serving: {queues.find(q => q.status === 'CALLING')?.ticketNumber || 'None'}</div>
                            ...
                            <div className="flex gap-4">
                                {user?.role === 'HELPDESK' && (
                                    ...
                                    >
                                        <Users2 className="w-5 h-5" /> REGISTER WALK-IN
                                    </Button>
                                )}
                                <Button
                                    size="lg"
